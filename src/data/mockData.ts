...
// Estes dados servem como "seed" inicial para a biblioteca no Supabase e como fallback local.
...
// Planos de treino pré-definidos - usados como base para criar planos reais no Supabase
// através do onboarding e do modal de planos pré-definidos.
